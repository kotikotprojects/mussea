...
class Content:
    ...
    async def from_id(self, video_id: str) -> Optional[ContentStudioVideo | PropagatePhotosNeeded]:
        return await self.from_url(f"https://www.tiktok.com/@/video/{video_id}")

    async def from_url(self, url: str) -> Optional[ContentStudioVideo | PropagatePhotosNeeded]:
